...
export const LANGUAGES: Record<string, LanguageDef> = {
  ...
  csharp: {
    ...
    grammar: {
      ...
      version: '0.23.5',
      cli: '^0.26.5 (declared upstream)',
      abi: 15,
      wasmSha256: '6f69e1cae44e1c32c1eccc170dc5a9778fb94ff716f71113fe1f8c4299aa2f40',
      nodeTypesSha256: '91d69f7e0d97c002e738a09caadd8ddfa36b1552f7ae94303cc53b03b28551c0',
      source: { kind: 'npm', package: 'tree-sitter-c-sharp', wasmPath: 'tree-sitter-c_sharp.wasm', nodeTypesPath: 'src/node-types.json' },
    },
    commentTypes: ['comment'],
    commentDelimiters: ['//', '/*'],
  },
