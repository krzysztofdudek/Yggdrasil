...
export interface File {
  ...
  /** raw file content */
  content: string;
  /** parsed tree-sitter Tree for files of a registered language, built on first read; undefined otherwise. May carry parse errors (inspect ast.rootNode.hasError). */
  ast?: unknown;
