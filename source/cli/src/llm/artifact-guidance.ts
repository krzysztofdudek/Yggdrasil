...
- interface.md — CONTRACT: what consumers call, what they get back, what can go wrong. Exported function signatures, parameter types, return types, failure modes.
