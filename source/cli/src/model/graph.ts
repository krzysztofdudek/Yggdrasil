...
import type { RootsConfig } from '../roots/model.js';
...
/**
 * Roots-only types (`RootsConfig`, `SeedEntry`, `LedgerEntry`) now live in
 * `../roots/model.ts` — the roots engine's own types layer, inside its future
 * extraction boundary. Re-exported here VERBATIM so every existing importer
 * of this module (io/config-parser.ts, cli/roots.ts, tests, …) keeps working
 * unchanged; new code inside src/roots/** imports directly from ./model.js.
 */
export type { RootsConfig, SeedEntry, LedgerEntry } from '../roots/model.js';
