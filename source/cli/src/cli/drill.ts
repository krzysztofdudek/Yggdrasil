  ...
  const drill = program
    ...
    .action(async (opts) => {
      ...
      try {
        ...
        const details = new Map<DrillResult, string>();
...
export interface DrillSink {
  ...
  caseResult(result: DrillResult, detail: string | undefined): void;
}
...
export function drillDocument(
  ...
  details: ReadonlyMap<DrillResult, string>,
  exitCode: 0 | 1 | 2,
): DrillJsonDocument {
