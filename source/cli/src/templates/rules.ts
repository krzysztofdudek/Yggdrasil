...
| \`yg simulate <det-aspect> --node <path>\` | Replay a candidate SCRIPT rule over recent history in an isolated clone ("what would it have caught?"). Read-only, exits 0 whatever it finds. |
