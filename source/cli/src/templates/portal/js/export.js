...
(function () {
  ...
  function buildResidueCsv(data) {
    var rows = [['node', 'kind']];
    var res = (data.residue || { noRuleNodes: [], uncoveredFiles: [], typeCovered: [], excludedFiles: [] });
   ...
   * so `coveredFiles + typeCoveredCount + uncoveredFiles === totalFiles` is visible and
   * checkable in the exported artifact itself, not only in the live page.
   */
  function buildCoverageCsv(data) {
    ...
    var keys = [
      ...
      'suppressed', 'coveredFiles', 'uncoveredFiles', 'typeCoveredCount', 'typeCoveredUnenforced', 'excludedFiles', 'totalFiles', 'errors', 'warnings',
    ];
  ...
  function buildExportJson(data) {
    ...
    return {
      ...
      residue: data.residue || { noRuleNodes: [], uncoveredFiles: [], typeCovered: [], excludedFiles: [] },
    };
  }
