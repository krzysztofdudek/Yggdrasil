...
The `cli/core/check` module runs the full unified graph health check. It orchestrates validation (E001-E041), drift detection (E020-E021), coverage scanning (E022), and health score computation. It returns a `CheckResult` with all issues and a health score.
