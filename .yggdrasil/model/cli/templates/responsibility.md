...
Rules content is structured into three cognitive sections (protocol, operations, knowledge base) optimized for LLM attention patterns based on "Lost in the Middle" research. Default config and architecture templates provide minimal valid starting points for `yg init`. Graph schemas are copied to `.yggdrasil/schemas/` during init.
