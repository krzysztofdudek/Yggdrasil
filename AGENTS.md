...
- **Version bumps only on explicit user request.** Never bump the version in `source/cli/package.json` unless the user explicitly asks for a release. When they do:
  1. Bump to the family's release number, not a SemVer-derived one: the core (Yggdrasil, Grain, Horde) ships under one number, and a release that breaks things under a minor number says so in its changelog section (`docs/family-contracts.md`, "One number for the family").
...
<!-- yggdrasil:start -->
<!-- yggdrasil:digest cli=6.1.0 sha256=7f693ffa5729a5f62118e18f92137b194273675e185fc77d12da7f5604b9193d -->
## Yggdrasil
